    ...
    <Wrapper>
      {productsInCart.length >= 1 ? (
        <Container>
          ...
          <Info>
            Subtotal{" "}
            <PriceInfo>{nf.format(basketProps.cartCost)} vnd</PriceInfo>
          </Info>
          <Info>
          ...
          <Info>
            Additional fee{" "}
            <PriceInfo>{nf.format(additionalShippingFee)} vnd</PriceInfo>
          </Info>
          <Info>
            Total
            <PriceInfo>
              {" "}
              {nf.format(
                basketProps.cartCost + additionalShippingFee + shippingFee
              )}{" "}
              vnd
            </PriceInfo>
          </Info>
