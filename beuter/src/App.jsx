		...
		<div>
			...
			<NavBar>
				...
				<SearchBox show={isShowing} close={closeModalHandler}>
					...
					<SearchInput type="text" placeholder="Type something to search" onChange={handleSearch} />
					<SearchButton type="submit" value="Search" onClick={handleSearchButton} />
				</SearchBox>
			</NavBar>
			<Wrapper>
				<Container>
			...
			<div>
				{products
					...
					.map((filteredName) => <li>{filteredName.title}</li>)}
			</div>
		</div>
	);
}
